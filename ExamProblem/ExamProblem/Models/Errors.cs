...
namespace ExamProblem.Models
{
    public static class Errors
    {
        ...
        public static string NumberOfStarsTooSmall = "Given number of stars is smaller than 1.";
        public static string NumberOfStarsTooBig = "Given number of stars is greater than 400.";
